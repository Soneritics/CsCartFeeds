                ...
                {foreach from=$products item=product}
                    <tr class="cm-row-status-{$product.status|lower} {$hide_inputs_if_shared_product}">
                        <td class="left">
                            ...
                            <input type="checkbox" name="active_products[]" value="{$product.product_id}" class="checkbox cm-item"{if in_array($product.product_id, $activeProducts)} checked="checked"{/if} />
                        </td>
                        <td>
